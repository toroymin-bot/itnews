...
function buildBillingReportHTML(d) {
  ...
  return [
    ...
    '<div style="max-width:600px;margin:0 auto;background:#fff;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">',
    ...
    // 푸터
    '<div style="background:linear-gradient(135deg,#0078D4 0%,#005A9E 100%);background-color:#0078D4;padding:10px 16px;text-align:center;">',
    '<div style="font-size:12px;font-weight:700;color:#fff;margin-bottom:4px;">&#x2601;&#xFE0F; Google Cloud AI Billing Bot</div>',
    '<a href="https://console.cloud.google.com/billing/reports?project=' + BR_GCP_PROJECT + '" style="font-size:11px;color:rgba(255,255,255,0.85);text-decoration:none;margin:0 8px;">&#x1F517; 비용 보고서</a>',
    '<span style="color:rgba(255,255,255,0.4);font-size:11px;">|</span>',
    '<a href="https://console.cloud.google.com/bigquery?project=' + BR_GCP_PROJECT + '" style="font-size:11px;color:rgba(255,255,255,0.85);text-decoration:none;margin:0 8px;">&#x1F517; BigQuery</a>',
    '<div style="margin-top:4px;font-size:10px;color:rgba(255,255,255,0.6);">' + BR_GCP_PROJECT + ' &bull; ' + d.reportTime + '</div>',
    '</div>',
